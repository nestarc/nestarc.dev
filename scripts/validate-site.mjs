...
async function main() {
  ...
  for (const contract of [
    ...
    { pathname: '/packages/webhook/', target: '/ko/packages/webhook/', label: 'Korean webhook locale switch' },
    { pathname: '/ko/packages/webhook/', target: '/packages/webhook/', label: 'English webhook locale switch' },
    { pathname: '/packages/webhook/', target: '/packages/webhook/agent-guide', label: 'webhook agent guide' },
