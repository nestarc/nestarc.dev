...
| Package | Status | Version | Solves | Start here |
| --- | --- | --- | --- | --- |
| <span data-catalog-surface="package-matrix" data-catalog-package="soft-delete" data-version="0.7.1" data-status="Supported"><a href="/packages/soft-delete/"><code>@nestarc/soft-delete</code></a></span> | Supported | `0.7.1` | Prisma 5/6/7 soft delete, relation filters, cascade, bulk restore, purge, and optional atomic audit lifecycles. | Deleting records must preserve auditability and avoid accidental reads. |
