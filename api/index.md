...
API reference entry point for all current nestarc packages.
...
| @nestarc/idempotency | Beta | [View API](/api/idempotency/) | [Guide](/packages/idempotency/) | [GitHub](https://github.com/nestarc/nestjs-idempotency) |
...
They intentionally stay visible so new users can see the full 12-package surface instead of assuming the missing TypeDoc pages are unavailable packages.
