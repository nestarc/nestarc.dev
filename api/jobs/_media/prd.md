...
- **Fairness 알고리즘**: Shard-based **weighted round-robin**. Token bucket은 fairness가 아닌 rate limiting 도구로 재규정(ScienceDirect, Inngest 블로그). v0.2에 token bucket을 _rate limit_ 옵션으로 추가
