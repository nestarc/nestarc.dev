...
> [!NOTE]
> 상태: `HISTORICAL / COMPLETED (v0.1)`. 이 문서의 결정을 새 backlog로 실행하지 않는다.
> 현재 계약은 [README](https://github.com/nestarc/api-keys/blob/c7a7cd4ea07b26bee029c078aaca83d9af32a54e/README.md), 미완료 작업은
...
lifecycle event, context helper의 상세 스펙은 [`spec-0.2.md`](https://github.com/nestarc/api-keys/blob/c7a7cd4ea07b26bee029c078aaca83d9af32a54e/docs/spec-0.2.md)를
기준으로 한다.
