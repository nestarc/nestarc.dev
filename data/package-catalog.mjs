...
export const packageCatalog = [
  ...
  },
  {
    ...
    adoptionStage: 3,
    homeSummary: {
      en: 'Prisma CUD tracking with query cursors, retention, partitions, and actor metadata.',
      ko: 'Prisma 7 CUD 추적, Query API, retention, partition, actor metadata를 제공합니다.',
    },
  ...
  },
  {
    ...
    adoptionStage: 4,
    homeSummary: {
      en: 'Tenant-fair in-memory scheduling plus a BullMQ FIFO backend, with shared handlers and context propagation.',
      ko: '테넌트 공정 in-memory scheduling과 BullMQ FIFO backend를 동일한 handler 및 context propagation 모델로 제공합니다.',
    },
    solves: 'Tenant-fair in-memory scheduling, BullMQ FIFO workers, context propagation.',
