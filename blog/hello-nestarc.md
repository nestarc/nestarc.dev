...
author: nestarc
reviewed: 2026-08-28
versionScope: "NestJS 10/11, audit-log NestJS 12.0.1+, and @nestarc package releases current on August 28, 2026"
---
...
- **NestJS** 10/11 for the application framework; audit-log 0.5 additionally supports 12.0.1+
...
|---------|---------|-------------|
| `@nestarc/tenancy` | 0.15.0 | PostgreSQL RLS + Prisma multi-tenancy |
...
| `@nestarc/soft-delete` | 0.7.1 | Prisma soft-delete with optional atomic audit lifecycles, relation filters, and bulk restore |
...
| `@nestarc/outbox` | 0.2.0 | Transactional outbox for reliable domain events |
| `@nestarc/webhook` | 0.13.0 | Outbound webhook delivery with signing and retry |
| `@nestarc/api-keys` | 0.3.1 | Tenant-scoped API keys with scoped guards |
| `@nestarc/rbac` | 0.2.0 | Tenant-aware roles, permissions, and guards |
| `@nestarc/data-subject` | 0.2.0 | GDPR/CCPA export and erase workflows |
| `@nestarc/jobs` | 0.3.1 | Tenant-aware jobs with in-memory fairness, durable BullMQ retry/dedupe, and outbox publishing |
