...
- [Async Delivery Reference Workflow](/guide/async-delivery-workflow) — transactional outbox → durable job → signed webhook
...
- [Example: SaaS API](/guide/example-saas-api) — 7 core packages in one project ([GitHub](https://github.com/nestarc/example-saas-api))
- [Troubleshooting](/guide/troubleshooting) — step-by-step debugging for common issues
